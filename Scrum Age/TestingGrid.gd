...
func _on_Slot_pressed(slot):
	if Global.train_scores[Global.current_player-1] >= 20 && Global.req_scores[Global.current_player-1] >= 20 && Global.design_scores[Global.current_player-1] >= 15 && Global.imp_scores[Global.current_player-1] >= 10:
